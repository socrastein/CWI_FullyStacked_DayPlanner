...
/**
 *This creates an array of all the holiday's by storing the title and date information that will be needed to run createHolidayEvent() based on the year provided.  should be easier to update.
 * @param {Number} year
